...
class FindAccount extends Component {
    ...
    handleTableChange = (pagination, filters, sorter) => {
      ...
      rowClick(record){
        ...
        const {id} = record;
        this.props.history.push(`/dashboard/profile/${id}`);
      }
    //   Fetch data from api
    fetchData = (params = {}) => {
    ...
    render() {
        ...
        return (
            <div id="search-user">
                ...
                <span className="ant-form-text" style={{marginBottom:'10px'}}><b>Find Account</b></span>
                    <FormItem>
                ...
                <Datatable 
                    ...
                    rowEvent={this.rowClick.bind(this)}/>
            </div>
        );
    }
}

export default Form.create()(FindAccount);